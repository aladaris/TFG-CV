    ...
    ;; ADDITIVE 1 (TABLES)
    gi_DurTable2   ftgen   20, 0, 8, -2, 	8, 2, 2, 4, 8, 8, 2, 4   ; Duracion de los pasos (1, 2 ó 4 == Corchea, Negra ó Blanca)
    gi_NotesTable2 ftgen   21, 0, 8, -2,	7.01, 7.01, 7.03, 7.01, 7.01, 7.01, 7.05, 7.01
    gi_EnabledTable2 ftgen 22, 0, 8, -2,    0, 0, 0, 0, 0, 0, 0, 0  ;  Pasos activos == 1, inactivos == 0
    ;; SAMPLER 1 (TABLES)
